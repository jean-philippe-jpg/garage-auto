 ...
 */
final class Version20240329153152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_services CHANGE id_service id_service_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE services DROP id_detail, CHANGE id_motorisation_id id_motorisation_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_services CHANGE id_service_id id_service INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE services ADD id_detail INT DEFAULT NULL, CHANGE id_motorisation_id id_motorisation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE services ADD CONSTRAINT FK_7332E169C58F8C3E FOREIGN KEY (id_detail) REFERENCES details_services (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7332E169C58F8C3E ON services (id_detail)');
    }
}
